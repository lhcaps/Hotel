...
const DEMO = {
  ...
  roomTypes: [
    ...
    ['10000000-0000-4000-8000-000000000203', 'SIGNATURE', 'Signature', 4, 2, 6],
  ] as const,
  rooms: [
    ...
    async (pool) => {
      ...
      try {
        ...
        const basePlanPrices: ReadonlyArray<readonly [string, readonly [number, number, number]]> =
          [
            ['10000000-0000-4000-8000-000000000501', [300_000, 360_000, 420_000]], // THREE_HOUR_COMBO
            ['10000000-0000-4000-8000-000000000502', [450_000, 520_000, 590_000]], // FIVE_HOUR_COMBO
            ['10000000-0000-4000-8000-000000000504', [600_000, 680_000, 760_000]], // NIGHT_COMBO
            ['10000000-0000-4000-8000-000000000505', [800_000, 900_000, 1_000_000]], // DAY_COMBO
            ['10000000-0000-4000-8000-000000000506', [100_000, 110_000, 120_000]], // EXTRA_HOUR
          ];
