  ...
  await database.pool.query(
    `INSERT INTO properties (id, code, name, timezone)
     ...
     INSERT INTO price_tiers (id, property_id, code, name, sort_order)
       VALUES ('10000000-0000-4000-8000-000000000101', '10000000-0000-4000-8000-000000000001', 'DELUXE', 'Deluxe', 2),
              ('10000000-0000-4000-8000-000000000102', '10000000-0000-4000-8000-000000000001', 'STANDARD', 'Standard', 1),
              ('10000000-0000-4000-8000-000000000103', '10000000-0000-4000-8000-000000000001', 'SIGNATURE', 'Signature', 3);
     INSERT INTO room_types (id, property_id, price_tier_id, code, name, max_adults, max_children, max_occupancy)
       VALUES ('10000000-0000-4000-8000-000000000201', '10000000-0000-4000-8000-000000000001', '10000000-0000-4000-8000-000000000101', 'NAMI', 'Nami', 2, 1, 3),
              ('10000000-0000-4000-8000-000000000202', '10000000-0000-4000-8000-000000000001', '10000000-0000-4000-8000-000000000102', 'ROSE', 'Rose', 2, 1, 3),
              ('10000000-0000-4000-8000-000000000203', '10000000-0000-4000-8000-000000000001', '10000000-0000-4000-8000-000000000101', 'PHU_VAN', 'Phù Vân', 2, 1, 3),
              ('10000000-0000-4000-8000-000000000204', '10000000-0000-4000-8000-000000000001', '10000000-0000-4000-8000-000000000101', 'SUNSET', 'Sunset', 2, 1, 3),
              ('10000000-0000-4000-8000-000000000205', '10000000-0000-4000-8000-000000000001', '10000000-0000-4000-8000-000000000101', 'YUKI', 'Yuki', 2, 1, 3),
              ('10000000-0000-4000-8000-000000000206', '10000000-0000-4000-8000-000000000001', '10000000-0000-4000-8000-000000000101', 'SABI', 'Sabi', 2, 1, 3),
              ('10000000-0000-4000-8000-000000000207', '10000000-0000-4000-8000-000000000001', '10000000-0000-4000-8000-000000000101', 'SUDAL', 'Sudal', 2, 1, 3),
              ('10000000-0000-4000-8000-000000000208', '10000000-0000-4000-8000-000000000001', '10000000-0000-4000-8000-000000000103', 'WABI', 'Wabi', 2, 1, 3),
              ('10000000-0000-4000-8000-000000000209', '10000000-0000-4000-8000-000000000001', '10000000-0000-4000-8000-000000000103', 'HAVEN', 'Haven', 2, 1, 3);
     INSERT INTO rooms (id, property_id, room_type_id, room_number)
       VALUES ('10000000-0000-4000-8000-000000000301', '10000000-0000-4000-8000-000000000001', '10000000-0000-4000-8000-000000000201', '101'),
              ('10000000-0000-4000-8000-000000000302', '10000000-0000-4000-8000-000000000001', '10000000-0000-4000-8000-000000000202', '201'),
              ('10000000-0000-4000-8000-000000000303', '10000000-0000-4000-8000-000000000001', '10000000-0000-4000-8000-000000000203', '202'),
              ('10000000-0000-4000-8000-000000000304', '10000000-0000-4000-8000-000000000001', '10000000-0000-4000-8000-000000000204', '203'),
              ('10000000-0000-4000-8000-000000000305', '10000000-0000-4000-8000-000000000001', '10000000-0000-4000-8000-000000000205', '204'),
              ('10000000-0000-4000-8000-000000000306', '10000000-0000-4000-8000-000000000001', '10000000-0000-4000-8000-000000000206', '205'),
              ('10000000-0000-4000-8000-000000000307', '10000000-0000-4000-8000-000000000001', '10000000-0000-4000-8000-000000000207', '206'),
              ('10000000-0000-4000-8000-000000000308', '10000000-0000-4000-8000-000000000001', '10000000-0000-4000-8000-000000000208', '207'),
              ('10000000-0000-4000-8000-000000000309', '10000000-0000-4000-8000-000000000001', '10000000-0000-4000-8000-000000000209', '208');
...
INSERT INTO rate_plans (id, property_id, code, name, status, included_duration_minutes, priority,
     ...
     INSERT INTO rate_plan_prices (id, property_id, rate_plan_id, price_tier_id, amount_vnd)
       VALUES ('10000000-0000-4000-8000-000000000601', '10000000-0000-4000-8000-000000000001', '10000000-0000-4000-8000-000000000501', '10000000-0000-4000-8000-000000000101', 359000),
             ...
             ('10000000-0000-4000-8000-000000000608', '10000000-0000-4000-8000-000000000001', '10000000-0000-4000-8000-000000000501', '10000000-0000-4000-8000-000000000102', 359000),
             ('10000000-0000-4000-8000-000000000609', '10000000-0000-4000-8000-000000000001', '10000000-0000-4000-8000-000000000502', '10000000-0000-4000-8000-000000000102', 300000),
             ('10000000-0000-4000-8000-000000000610', '10000000-0000-4000-8000-000000000001', '10000000-0000-4000-8000-000000000503', '10000000-0000-4000-8000-000000000102', 450000),
             ('10000000-0000-4000-8000-000000000611', '10000000-0000-4000-8000-000000000001', '10000000-0000-4000-8000-000000000504', '10000000-0000-4000-8000-000000000102', 600000),
             ('10000000-0000-4000-8000-000000000612', '10000000-0000-4000-8000-000000000001', '10000000-0000-4000-8000-000000000505', '10000000-0000-4000-8000-000000000102', 800000),
             ('10000000-0000-4000-8000-000000000613', '10000000-0000-4000-8000-000000000001', '10000000-0000-4000-8000-000000000506', '10000000-0000-4000-8000-000000000102', 100000),
             ('10000000-0000-4000-8000-000000000614', '10000000-0000-4000-8000-000000000001', '10000000-0000-4000-8000-000000000507', '10000000-0000-4000-8000-000000000102', 200000),
             ('10000000-0000-4000-8000-000000000615', '10000000-0000-4000-8000-000000000001', '10000000-0000-4000-8000-000000000501', '10000000-0000-4000-8000-000000000103', 399000),
             ('10000000-0000-4000-8000-000000000616', '10000000-0000-4000-8000-000000000001', '10000000-0000-4000-8000-000000000502', '10000000-0000-4000-8000-000000000103', 399000),
             ('10000000-0000-4000-8000-000000000617', '10000000-0000-4000-8000-000000000001', '10000000-0000-4000-8000-000000000503', '10000000-0000-4000-8000-000000000103', 399000),
             ('10000000-0000-4000-8000-000000000618', '10000000-0000-4000-8000-000000000001', '10000000-0000-4000-8000-000000000504', '10000000-0000-4000-8000-000000000103', 399000),
             ('10000000-0000-4000-8000-000000000619', '10000000-0000-4000-8000-000000000001', '10000000-0000-4000-8000-000000000505', '10000000-0000-4000-8000-000000000103', 399000),
             ('10000000-0000-4000-8000-000000000620', '10000000-0000-4000-8000-000000000001', '10000000-0000-4000-8000-000000000506', '10000000-0000-4000-8000-000000000103', 100000),
             ('10000000-0000-4000-8000-000000000621', '10000000-0000-4000-8000-000000000001', '10000000-0000-4000-8000-000000000507', '10000000-0000-4000-8000-000000000103', 200000);
  ...
  await database.pool.query(
    `INSERT INTO users (id, name, email, email_verified, role, status)
     ...
     INSERT INTO booking_contacts (booking_id, full_name, normalized_email, normalized_phone_e164, email_digest)
       VALUES ('10000000-0000-4000-8000-000000000721', 'Synthetic UAT Guest', 'pw-uat-hold@example.test', '+84000000000', decode(repeat('ab', 32), 'hex')),
              ('10000000-0000-4000-8000-000000000722', 'Synthetic UAT Guest', 'pw-uat-confirmed@example.test', '+84000000000', decode(repeat('ab', 32), 'hex')),
              ('10000000-0000-4000-8000-000000000723', 'Synthetic UAT Guest', 'pw-uat-pending@example.test', '+84000000000', decode(repeat('ab', 32), 'hex')),
              ('10000000-0000-4000-8000-000000000724', 'Synthetic UAT Guest', 'pw-uat-cancelled@example.test', '+84000000000', decode(repeat('ab', 32), 'hex')),
              ('10000000-0000-4000-8000-000000000725', 'Synthetic UAT Guest', 'pw-uat-expired@example.test', '+84000000000', decode(repeat('ab', 32), 'hex'))
     ...
     INSERT INTO payments (id, property_id, booking_id, status, amount_vnd, currency, confirmation_source, succeeded_at)
       VALUES ('10000000-0000-4000-8000-000000000731', '10000000-0000-4000-8000-000000000001', '10000000-0000-4000-8000-000000000722', 'SUCCEEDED', 359000, 'VND', 'PROVIDER_EVENT', '2027-07-11T05:30:00.000Z'),
              ...
              ('10000000-0000-4000-8000-000000000733', '10000000-0000-4000-8000-000000000001', '10000000-0000-4000-8000-000000000724', 'SUCCEEDED', 419000, 'VND', 'PROVIDER_EVENT', '2027-07-13T01:05:00.000Z');
     INSERT INTO operational_reviews (id, property_id, booking_id, payment_id, category, status, opened_at, opened_reason)
       VALUES ('10000000-0000-4000-8000-000000000741', '10000000-0000-4000-8000-000000000001', '10000000-0000-4000-8000-000000000724', '10000000-0000-4000-8000-000000000733', 'PAID_CANCELLATION', 'OPEN', '2027-07-13T01:10:00.000Z', 'Synthetic Playwright paid-cancellation review.');`,
  );
}
